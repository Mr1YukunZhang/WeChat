...
data = {"weather":{"value":wea},"city":{"value":city , "color":'#98FB98'},"temperature":{"value":temperature , "color":'#DB7093'},"love_days":{"value":get_count() , "color":'#FFB6C1'},"birthday_left":{"value":get_birthday()},"birthday_right":{"value":get_birthday1()},"words":{"value":get_words(), "color":get_random_color()}}
